...
<h1 className='text-xl font-bold text-[#ff9900]'>Welcome, {userData.fullName}</h1>
<p className='text-[#ff9900] '><span className='font-semibold'>Latitude:</span> {deliveryBoyLocation?.lat}, <span className='font-semibold'>Longitude:</span> {deliveryBoyLocation?.lon}</p>
    </div>

<div className='bg-white rounded-2xl shadow-md p-5 w-[90%] mb-6 border border-orange-100'>
  <h1 className='text-lg font-bold mb-3 text-[#ff9900] '>Today Deliveries</h1>
